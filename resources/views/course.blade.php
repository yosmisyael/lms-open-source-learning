...
<div class="container p-5">
  <div class="row">
    <div class="col col-md-4 mx-auto">
      <form action="/enroll/{{ $data->id }}" method="post">
        @csrf
        <button type="submit" class="btn btn-primary w-100 py-2 fw-bold fs-5">Enroll</button>
      </form>
    </div>
  </div>
</div>
...
@if ($course_ratings->count())
  <div class="container py-5">
    <div class="row mb-4">
      <div class="col-md-12 text-center">
        <div class="lc-block mb-4">
            <h2 editable="inline" class="rfs-25 fw-bolder">Testimonials</h2>  
          <p editable="inline"> Some motivational tales from those who have previously benefited from OSL.</p>
        </div><!-- /lc-block -->
      </div>
    </div>
