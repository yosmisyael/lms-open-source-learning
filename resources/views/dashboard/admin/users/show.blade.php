        ...
        <tbody>
          @foreach ($questions as $q)
            <tr>
              ...
              <td>{{ $q->content }}</td>
              <td>
                  <a href="/admin/dashboard/tests/{{ $data->id }}/questions/{{ $q->id }}" class="btn btn-primary"><i class="bi bi-eye-fill"></i> Detail</a>
                  <a href="/admin/dashboard/tests/{{ $data->id }}/questions/{{ $q->id }}/edit" class="btn btn-warning"><i class="bi bi-pencil-square"></i> Update</a>
